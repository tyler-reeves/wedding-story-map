var config = {
    ...
    accessToken: 'pk.eyJ1IjoidHJlZXZlczEyMyIsImEiOiJjbXR1ZXhoY28wMm50MnlzYzRyamkzNXdqIn0.XOj7fpjZ6vRIl0orhLheXA',
    showMarkers: true,
    markerColor: '#3FB1CE',
    ...
    auto: false,
    title: 'Our Story',
    subtitle: 'A timeline of how we met, and the many places we\'ve called home',
    byline: 'Lottie and Tyler',
    footer: '',
    chapters: [
        {
            id: 'slug-style-id',
            ...
            description: 'Born in Sacramento...',
            location: {
                center: [-121.45186568597802, 38.566321225198564],
                zoom: 6,
                pitch: 60,
                bearing: 0
            },
